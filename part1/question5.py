...
SELECT animals.name, favorite_foods.name FROM animals INNER JOIN favorite_foods ON animals.favorite_food_id = favorite_foods.food_id WHERE favorite_foods.vegetarian = 1
